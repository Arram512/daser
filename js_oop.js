...
class Parent {
	...
	constructor(bookName, bookPages){
		this.name = bookName
		this.pages = bookPages
		
	}
	functionName = function(){return console.log(this.name, this.pages)}
...
const exm = new Child("A byte of python")
console.log(exm.functionName())
